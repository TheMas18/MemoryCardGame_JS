      ...
      for (let i = 0; i < boardSize; i++) {
			...
			for (let j = 0; j < boardSize; j++) {
			  ...
			  if(boardName == "game-board"){
				 ...
				 createImageCard.innerHTML += `<img class="${cardImagesArray[(j+4*i)% boardSize]} " src=images/${cardImagesArray[rands[k%rands.length]]}.svg />`;
